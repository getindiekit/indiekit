...
export const icon = (name, title) => {
  const paths = {
    ...
    recipe:
      "M36 4H12c-4.5 0-8 3.5-8 8v24c0 4.5 3.5 8 8 8h24c4.5 0 8-3.5 8-8V12c0-4.5-3.5-8-8-8ZM12 40a4 4 0 0 1-4-4V12a4 4 0 0 1 4-4h24a4 4 0 0 1 4 4v24a4 4 0 0 1-4 4h-8v4h-8v-4h-8Zm10 4V31c-2.5 0-4.5-2-4.5-4.5V12h3v12h2V12h3v12h2V12h3v14.5c0 2.5-2 4.5-4.5 4.5v13h-4Z",
    reply:
